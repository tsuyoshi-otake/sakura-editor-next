...
Each job's first step page also lists the job's own log, opened by the separate
`sakura.githubActions.openJobLog` command. The log is downloaded by the `jobLog`
