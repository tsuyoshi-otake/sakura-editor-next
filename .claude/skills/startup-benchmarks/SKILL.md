...
description: Startup performance measurement baselines and history for this repository. Use when measuring, comparing, or discussing startup performance, ISA/optimization effects, or instrumented serial-path phases. Contains the measurement protocol pointers and all dated baseline tables (2026-07-30/31).
---
