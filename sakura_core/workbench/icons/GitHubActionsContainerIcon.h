...
//! via FillLayer's `color` parameter. The light/dark colours below are unused
//! placeholders required by StatusIconLayer's constructor.
constexpr StatusIconLayer kExplorerLayer{ 24, false, kExplorerPath, 0, 0 };
