...
static_assert(sizeof(SakuraOutputProviderStatus) == 4);
static_assert(sizeof(SakuraOutputProviderOperationStatus) == 4);
static_assert(sizeof(SakuraOutputProviderReason) == 4);
...
static_assert(alignof(SakuraOutputProviderSpanV1) == 8);
static_assert(alignof(SakuraOutputProviderLimitsV1) == 8);
static_assert(alignof(SakuraOutputProviderLogEntryV1) == 8);
static_assert(alignof(SakuraOutputProviderRequestV1) == 8);
static_assert(alignof(SakuraOutputProviderApplyResultV1) == 8);
static_assert(alignof(SakuraOutputProviderSnapshotReceiptV1) == 8);
static_assert(alignof(SakuraOutputProviderSnapshotInfoV1) == 8);
static_assert(alignof(SakuraOutputProviderSnapshotBufferV1) == 8);
static_assert(alignof(SakuraOutputProviderActiveChannelV1) == 8);
static_assert(offsetof(SakuraOutputProviderSpanV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderSpanV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderSpanV1, data) == 8);
static_assert(offsetof(SakuraOutputProviderSpanV1, length) == 16);
static_assert(offsetof(SakuraOutputProviderSpanV1, reserved) == 24);
static_assert(offsetof(SakuraOutputProviderLimitsV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderLimitsV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderLimitsV1, maximum_owners) == 8);
static_assert(offsetof(SakuraOutputProviderLimitsV1, maximum_channels) == 16);
static_assert(offsetof(SakuraOutputProviderLimitsV1, maximum_text_bytes_per_channel) == 24);
static_assert(offsetof(SakuraOutputProviderLimitsV1, maximum_payload_bytes) == 32);
static_assert(offsetof(SakuraOutputProviderLimitsV1, maximum_log_entries_per_channel) == 40);
static_assert(offsetof(SakuraOutputProviderLimitsV1, maximum_remembered_operations) == 48);
static_assert(offsetof(SakuraOutputProviderLimitsV1, reserved) == 56);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, level) == 8);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, flags) == 12);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, message) == 16);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, source) == 56);
static_assert(offsetof(SakuraOutputProviderLogEntryV1, reserved) == 96);
static_assert(offsetof(SakuraOutputProviderRequestV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderRequestV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderRequestV1, operation_kind) == 8);
static_assert(offsetof(SakuraOutputProviderRequestV1, channel_kind) == 12);
static_assert(offsetof(SakuraOutputProviderRequestV1, flags) == 16);
...
static_assert(offsetof(SakuraOutputProviderRequestV1, owner_id) == 72);
static_assert(offsetof(SakuraOutputProviderRequestV1, owner_generation) == 112);
static_assert(offsetof(SakuraOutputProviderRequestV1, channel_id) == 120);
static_assert(offsetof(SakuraOutputProviderRequestV1, label) == 160);
static_assert(offsetof(SakuraOutputProviderRequestV1, metadata_language_id) == 200);
static_assert(offsetof(SakuraOutputProviderRequestV1, metadata_source) == 240);
static_assert(offsetof(SakuraOutputProviderRequestV1, payload) == 280);
static_assert(offsetof(SakuraOutputProviderRequestV1, log_entries) == 320);
static_assert(offsetof(SakuraOutputProviderRequestV1, log_entry_count) == 328);
static_assert(offsetof(SakuraOutputProviderRequestV1, reserved) == 336);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, status) == 8);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, reason) == 12);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, revision) == 16);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, callback_drain_deferred) == 24);
static_assert(offsetof(SakuraOutputProviderApplyResultV1, reserved) == 25);
static_assert(offsetof(SakuraOutputProviderSnapshotReceiptV1, measurement_id) == 0);
...
static_assert(offsetof(SakuraOutputProviderSnapshotReceiptV1, channel_count) == 24);
static_assert(offsetof(SakuraOutputProviderSnapshotReceiptV1, encoded_size) == 32);
static_assert(offsetof(SakuraOutputProviderSnapshotReceiptV1, stopped) == 40);
static_assert(offsetof(SakuraOutputProviderSnapshotReceiptV1, active_channel_present) == 41);
static_assert(offsetof(SakuraOutputProviderSnapshotReceiptV1, reserved) == 42);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, revision) == 8);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, stopped) == 16);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, active_channel_present) == 17);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, reserved0) == 18);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, dropped_notification_count) == 24);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, channel_count) == 32);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, encoded_size) == 40);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, reserved) == 48);
static_assert(offsetof(SakuraOutputProviderSnapshotInfoV1, receipt) == 64);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, data) == 8);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, capacity) == 16);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, length) == 24);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, reserved) == 32);
static_assert(offsetof(SakuraOutputProviderSnapshotBufferV1, receipt) == 48);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, struct_size) == 0);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, abi_version) == 4);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, revision) == 8);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, present) == 16);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, reserved0) == 17);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, data) == 24);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, capacity) == 32);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, length) == 40);
static_assert(offsetof(SakuraOutputProviderActiveChannelV1, reserved) == 48);
