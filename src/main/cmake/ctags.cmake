...
string(SHA256 CTAGS_FALLBACK_SIGNATURE
  "${CTAGS_VERSION}|${ARCH}")
...
elseif(CMAKE_GENERATOR MATCHES "^Visual Studio" AND
  ...
  set(CTAGS_FALLBACK_STATE "${OUTPUT_DIRECTORY}/.ctags-source-state")
  add_custom_target(generate_ctags ALL
    COMMAND ${CMAKE_COMMAND}
      -DMODE:STRING=CTAGS
      -DSEVEN_ZIP_EXECUTABLE:FILEPATH=${7ZIP_EXECUTABLE}
      -DOUTPUT_DIRECTORY:PATH=${OUTPUT_DIRECTORY}
      -DSTATE_FILE:FILEPATH=${CTAGS_FALLBACK_STATE}
      -DBUILD_SIGNATURE:STRING=${CTAGS_FALLBACK_SIGNATURE}
      -DARCHIVE_FILE:FILEPATH=${CTAGS_ZIP_FILE}
      -DOUTPUT_FILE:FILEPATH=${CTAGS_EXECUTABLE}
      -P ${ARCHIVE_RUNTIME_SCRIPT}
    BYPRODUCTS
      "${CTAGS_EXECUTABLE}"
      "${CTAGS_FALLBACK_STATE}"
    DEPENDS
      "${CTAGS_ZIP_FILE}"
