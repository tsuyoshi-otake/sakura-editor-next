...
if(NOT DEFINED SAKURA_LEGACY_CONSUMER_COMPILE_TARGET OR
  ...
  message(FATAL_ERROR "Legacy component integration targets were not provided for tests1")
endif()
...
if(MSVC)
  target_compile_options("${SAKURA_LEGACY_CONSUMER_COMPILE_TARGET}" PRIVATE "$<$<CONFIG:Debug>:/FI${CMAKE_SOURCE_DIR}/src/main/modules/generated/abi/cmake-msvc-x64-debug/tests1.h>" "$<$<CONFIG:Release>:/FI${CMAKE_SOURCE_DIR}/src/main/modules/generated/abi/cmake-msvc-x64-release/tests1.h>")
elseif(MINGW)
  target_compile_options("${SAKURA_LEGACY_CONSUMER_COMPILE_TARGET}" PRIVATE "$<$<CONFIG:Debug>:-include>" "$<$<CONFIG:Debug>:${CMAKE_SOURCE_DIR}/src/main/modules/generated/abi/mingw-x64-debug/tests1.h>" "$<$<CONFIG:Release>:-include>" "$<$<CONFIG:Release>:${CMAKE_SOURCE_DIR}/src/main/modules/generated/abi/mingw-x64-release/tests1.h>")
endif()
